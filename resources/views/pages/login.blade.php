...
<div class="row">
    <div class="col-md pt-3">
        <img src="images/login.svg" style="width: 500px" class="d-block mx-auto mb-3 pt-5 pb-5 img-fluid">
    </div>
    <div class="col-md">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <h6 class="text-xs text-color-gray pb-2">
                    Don't have an account? <span class="fw-bold ms-1" ><a href="#" class="text-primary">Sign up</a></span>
                </h6>
            </div>
        </div>
        ...
        <div class="container-fluid shadow-xs p-4 bg-body rounded mb-3">
            ...
            <div class="form-check text-xs mt-4 grid gap-2 d-md-flex justify-content-md-end">
