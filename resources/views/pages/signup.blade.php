...
<div class="row">
    <div class="col-md mt-3">
        <img src="images/signup.svg" style="width: 500px" class="d-block mx-auto mb-3 pt-5 pb-5 img-fluid">
    </div>
    <div class="col-md">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <h6 class="text-xs text-color-gray pb-2">
                    Already have an account? <span class="fw-bold ms-1" ><a href="#" class="text-primary">Login</a></span>
                </h6>
            </div>
        </div>
        ...
        <div class="container-fluid shadow-xs p-4 bg-body rounded mb-3">
            <div class="row">
                <div class="col-md mb-2">
                    <h6 class="text-xs text-color-gray">Username</h6>
                        ...
                        <input class="form-control text-xs rounded" name="title" type="text" placeholder="Enter username" aria-label="default input example">
                ...
                <div class="col-md">
                    <h6 class="text-xs text-color-gray">ID Number</h6>
                        ...
                        <input class="form-control text-xs rounded" name="title" type="text" placeholder="Enter ID number" aria-label="default input example">
            ...
            <input class="form-control text-xs rounded" name="title" type="text" placeholder="Enter teacher name" aria-label="default input example">
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <div class="input-group gap-2">
                        ...
                        <input class="form-control text-xs rounded" name="title" type="email" placeholder="Enter email" aria-label="default input example">
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <div class="input-group gap-2">
                        ...
                        <input class="form-control text-xs rounded" name="title" type="password" placeholder="Enter password" aria-label="default input example">
                    </div>
                </div>
                <div class="col-md">
                    ...
                    <div class="input-group gap-2">
                        <input class="form-control text-xs rounded" name="title" type="password" placeholder="Confirm Password" aria-label="default input example">
                    </div>
                </div>
            </div>
            ...
            <input class="form-control text-xs rounded" name="title" type="text" placeholder="Enter sign up code" aria-label="default input example">
            ...
            <button type="submit" class="btn btn-primary text-xs fw-bold mt-4 pt-2 pb-2" id="save" style="width: 100%">
                Continue
